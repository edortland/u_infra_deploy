...
Param(
  ...
  [string] $ResourceGroupName = 'usgt_domain',  
  [switch] $UploadArtifacts,
  [string] $StorageAccountName,
  [string] $StorageAccountResourceGroupName, 
  [string] $StorageContainerName = $ResourceGroupName.ToLowerInvariant() + '-stageartifacts',
  [string] $TemplateFile = '..\Templates\azuredeploy_domain.json',
  [string] $TemplateParametersFile = '..\Templates\azuredeploy_domain.paramters.json',
